          ...
          <div className="flex min-h-[55vh] items-center justify-center">
            <div className="dashboard-card flex max-w-md flex-col items-center p-8 text-center">
              ...
              <p className="mt-2 text-sm leading-6 text-zinc-500">
                ...
                Rush RMA and Social are being refreshed.
              </p>
            </div>
          </div>
        ) : (
          /*
           * When route-level auto sync finishes, syncVersion changes.
           * React remounts the active report page and its normal
